...
set HOST_CC_PATH=%SCRIPTDIR:\=/%/cl-host.bat
set HOST_LD_PATH=%SCRIPTDIR:\=/%/link-host.bat
...
%BASH% configure --prefix="%INSTALLDIR%" --disable-all --disable-autodetect --disable-static --enable-shared --disable-debug ^
  ...
  --enable-gpl --enable-libx264 --enable-libopus --enable-vulkan ^
  --enable-d3d11va --enable-mediafoundation ^
  --enable-encoder=ffv1,qtrle,libx264*,aac,flac,libopus,pcm_s16be,pcm_s16le ^
