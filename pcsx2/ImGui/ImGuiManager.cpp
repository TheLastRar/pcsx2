...
void ImGuiManager::SetFontPath(std::string path, std::vector<std::string> fallback_paths)
{
	if (s_font_path == path && s_font_fallback_paths == fallback_paths)
		return;
...
ImFont* ImGuiManager::AddTextFont()
{
	...
	// clang-format off
	static constexpr ImWchar range_exclude_icons[] = { 0x2198,0x2208,0x221a,0x221a,0x227a,0x227d,0x22bf,0x22c8,0x2349,0x2349,0x235a,0x2367,0x237a,0x237f,0x23b2,0x23b5,0x23cc,0x23cc,0x23f4,0x23f7,0x2427,0x2443,0x2460,0x246b,0x248f,0x248f,0x24f5,0x24ff,0x2605,0x2605,0x2699,0x2699,0x278a,0x278e,0xff21,0xff3a,0x0,0x0 };
	// clang-format on
