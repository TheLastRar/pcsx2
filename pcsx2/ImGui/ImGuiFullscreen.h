...
#define HEX_TO_IMVEC4(hex, alpha) \
	...
	ImVec4 CenterImage(const ImVec2& fit_size, const ImVec2& image_size, bool fill = false);
	ImVec4 CenterImage(const ImVec4& fit_rect, const ImVec2& image_size, bool fill = false);
