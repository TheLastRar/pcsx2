...
void ImGuiFullscreen::SetFonts(ImFont* standard_font, ImFont* medium_font, ImFont* large_font, float standard_size, float medium_size, float large_size)
{
	g_standard_font = {standard_font, standard_size};
	g_medium_font = {medium_font, medium_size};
	g_large_font = {large_font, large_size};
}
...
bool ImGuiFullscreen::BeginFullscreenColumns(const char* title, float pos_y, bool expand_to_screen_width, bool footer)
{
	...
	if (title)
	{
		ImGui::PushFont(g_large_font.first);
...
bool ImGuiFullscreen::MenuButton(const char* title, const char* summary, bool enabled, float height, std::pair<ImFont*, float> font, std::pair<ImFont*, float> summary_font)
{
	...
	if (summary)
	{
		ImGui::PushFont(summary_font.first);
	...
	bool enabled, float height, const ImVec2& uv0, const ImVec2& uv1, std::pair<ImFont*, float> title_font, std::pair<ImFont*, float> summary_font)
{
	...
	ImGui::PushFont(title_font.first);
	ImGui::RenderTextClipped(title_bb.Min, title_bb.Max, title, nullptr, nullptr, ImVec2(0.0f, 0.0f), &title_bb);
	ImGui::PopFont();
...
void ImGuiFullscreen::DrawBackgroundProgressDialogs(ImVec2& position, float spacing)
{
	...
	ImGui::PushFont(g_medium_font.first);
