...
ImVec4 ImGuiFullscreen::CenterImage(const ImVec2& fit_size, const ImVec2& image_size, bool fill)
{
...
ImVec4 ImGuiFullscreen::CenterImage(const ImVec4& fit_rect, const ImVec2& image_size, bool fill)
{
	const ImRect rect(fit_rect);
	ImRect ret(CenterImage(rect.Max - rect.Min, image_size, fill));
