...
private:
	enum DIRTY_FLAG : u32
	{
		...
		DIRTY_FLAG_TFX_RT_TEX_TEXTURES = (1 << 4),
		DIRTY_FLAG_TFX_RT_UAV_TEXTURES = (1 << 5),

		DIRTY_FLAG_TFX_RT_TEXTURES = DIRTY_FLAG_TFX_RT_TEX_TEXTURES | DIRTY_FLAG_TFX_RT_UAV_TEXTURES,
		...
		DIRTY_FLAG_VS_PUSH_CONSTANTS = (1 << 13),
