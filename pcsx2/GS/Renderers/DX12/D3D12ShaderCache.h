...
public:
	...
	bool Open(D3D_SHADER_MODEL shader_model, bool debug);
	void Close();
...
private:
	...
	static std::string GetCacheBaseFileName(const std::string_view type, D3D_SHADER_MODEL feature_level, bool debug);
