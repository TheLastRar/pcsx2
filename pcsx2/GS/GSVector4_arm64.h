...
#define LOG_POLY5(x, c0, c1, c2, c3, c4, c5) (LOG_POLY4(x, c1, c2, c3, c4, c5).madd(x, GSVector4(c0)))
	...
	__forceinline GSVector4 blend32(const GSVector4& a) const
	{
		...
		constexpr u8 xn = (mask & 1) ? 4 : 0;
		constexpr u8 yn = (mask & 2) ? 5 : 1;
		constexpr u8 zn = (mask & 4) ? 6 : 2;
		constexpr u8 wn = (mask & 8) ? 7 : 3;
		...
		int8x16x2_t tbl{vreinterpretq_s8_f32(v4s), vreinterpretq_s8_f32(a.v4s)};
